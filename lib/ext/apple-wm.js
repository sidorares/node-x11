...
exports.requireExt = function (display, callback) {
  ...
  X.QueryExtension("Apple-WM", function (err, ext) {
    if (!ext.present) callback(new Error("extension not available"));
    ...
    ext.FrameGetRect = function (
      ...
      X.seq_num++;
      X.pack_stream.pack("CCSSSSSSSSSSS", [
        ext.majorOpcode,
        1,
        6,
        frame_class,
    ...
    ext.FrameHitTest = function (
      ...
      X.seq_num++;
      X.pack_stream.pack("CCSSxxSSSSSSSSSS", [
        ext.majorOpcode,
        2,
        7,
        frame_class,
    ...
    ext.FrameDraw = function (
      ...
      X.pack_stream.pack("CCSLLSSSSSSSSSSLp", [
        ext.majorOpcode,
        3,
        9 + titleReqWords,
        screen,
...
*/
    ...
    X.eventParsers[ext.firstEvent + ext.events.AppleWMControllerNotify] =
      ...
      X.eventParsers[ext.firstEvent + ext.events.AppleWMPasteboardNotify] =
        function (type, seq, extra, code, raw) {
          var event = {};
          switch (type) {
