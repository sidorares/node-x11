...
structs.DEPTH.pack = function packDEPTH(obj, format) {
  ...
  obj.visuals = Array.isArray(obj.visuals) ? obj.visuals : [obj.visuals]
  var i = 0
...
structs.SCREEN.pack = function packSCREEN(obj, format) {
  ...
  obj.allowed_depths = Array.isArray(obj.allowed_depths) ? obj.allowed_depths : [obj.allowed_depths]
  var i = 0
...
structs.Setup.pack = function packSetup(obj, format) {
  ...
  obj.pixmap_formats = Array.isArray(obj.pixmap_formats) ? obj.pixmap_formats : [obj.pixmap_formats]
  var i = 0
  ...
  obj.roots = Array.isArray(obj.roots) ? obj.roots : [obj.roots]
  var i = 0
...
structs.HOST.pack = function packHOST(obj, format) {
  ...
  obj.address = Array.isArray(obj.address) ? obj.address : [obj.address]
