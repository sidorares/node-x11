...
exports.requireExt = function (display, callback) {
  ...
  X.QueryExtension("RENDER", function (err, ext) {
      ...
      if (
        ...
        if (filterParams.length !== 0) {
          throw (
            ...
            name +
            '" - unexpected parameters for filters'
          );
        }
    ...
    ext.CompositeGlyphs16 = function (
      op,
      src,
      dst,
      maskFormat,
    ...
    ext.CompositeGlyphs32 = function (
      op,
      src,
      dst,
      maskFormat,
