...
for (var i = 0; i < bitmap.length; ++i) {
  var byteNum = i % 4;
  if (byteNum == 0) bitmap[i] = parseInt((i / 512) % 256);
  if (byteNum == 1) bitmap[i] = parseInt((i / 2048) % 256);
  if (byteNum == 2) bitmap[i] = parseInt((i / 256) % 256);
  if (byteNum == 2) bitmap[i] = parseInt((i / 1024) % 256);
}
