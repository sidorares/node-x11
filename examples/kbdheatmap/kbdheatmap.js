...
function main(X) {
  ...
  var win = X.AllocID();
  X.CreateWindow(win, root, 0, 0, kbdImg.width, kbdImg.height, 0, 0, 0, 0, {
    backgroundPixel: white,
    eventMask: Exposure | KeyPress | ButtonPress,
  });
  X.MapWindow(win);

  var win1 = X.AllocID();
  X.CreateWindow(win1, root, 0, 0, kbdImg.width, kbdImg.height, 0, 0, 0, 0, {
    backgroundPixel: white,
    eventMask: Exposure | KeyPress | ButtonPress,
  });
  X.MapWindow(win1);
